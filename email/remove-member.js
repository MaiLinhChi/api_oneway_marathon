...
const sendEmailRemoveMember =  (group, removedUser, leader) => {
    return (
        `
        <!DOCTYPE html>
        <html lang="en">
            ...
            <body>
                <div class="wrapper">
                    ...
                    <div class="wrapper-top">
                        <h1>Thông báo thành viên bị xóa khỏi nhóm ${group.groupName}<h1>
                        <p class="font-size">
                            Xin chào ${removedUser.fullName}, <br />
                            Đăng kí của bạn vừa được xóa bỏi trưởng nhóm ${group.groupName}
                        </p>
                    </div>
